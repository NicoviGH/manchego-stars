...
## Next (priority order)
1. **Design the ch02 map** (#22) — 15×15 snow-road reskin of FE8 Ch2 ("same choke points + spawn
...
2. **Host ch02 (full slice)** once the map lands — write `inject_ch02` modeled on `inject_ch01`: host on
