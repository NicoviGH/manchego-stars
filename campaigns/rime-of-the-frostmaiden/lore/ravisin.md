# Ravisin — the frost druid (ch05 boss) — Lore & Voice

> **DRAFT — Phase 0 of the ch05 dialogue pass (2026-07-23). Co-written with Nicolas;
> NOT locked until he red-pens the §Voice.** Boss of ch05 "The Elven Tomb." Mechanics
> live in [`chapters/ch05-the-elven-tomb.yaml`](../chapters/ch05-the-elven-tomb.yaml)
> (vanilla FE8 Druid, Flux at 1-2 range). Canon: *Rime of the Frostmaiden* pp.80-83.
> She is **distinct from Sephek Kaltro** ([`sephek-kaltro.md`](sephek-kaltro.md)) — both
> serve Auril, but they are opposite temperaments; see §Voice.
...
- **Tender register for beasts, scornful for people** — the same voice, two temperatures.
  She'll gentle the moose in one breath and damn the party in the next.
- Fervent rhythm: short declaratives that build, a rise before the turn. She preaches.
- **One device per scene** (device budget): her natural one is a rising tricolon
