# Meesmickle — Lore & Flavor

> Narrative and flavor for Meesmickle. **Mechanics live in [`pcs/meesmickle.yaml`](../pcs/meesmickle.yaml)** —
> Meesmickle is a stock vanilla FE8 class with no per-character abilities. Everything below is
...
In-game Meesmickle is a plain FE8 class; none of these are implemented as skills, procs, or buffs.
...
Death Knell — a mournful bell that tolls louder for the already-wounded.

- *Former mechanic concept (now flavor):* dark tome cantrip; deals extra damage to targets below full HP

### Hellish Rebuke

Spite — strike the cat and hellfire lashes back up your arm.

- *Former mechanic concept (now flavor):* counterattack proc: when hit in melee, auto-deal fire damage to the attacker
...
Hellfire Burst — a bead of fiend-fire that blooms into an inferno.

- *Former mechanic concept (now flavor):* fire siege tome (AoE compromised to siege-range single-target)
...
Evil Eye — a baleful stare that sickens, panics, or simply drops a foe where it stands.

- *Former mechanic concept (now flavor):* 1/chapter status proc: inflict one of poison / fear-debuff / sleep on a target
