...
- **Best framing recipe for tall-headgear subjects** (RBG-style): crop to the **shoulder width, bottom-anchored** (find the widest lower row's x-span, set that as the crop width, height = width/1.2 up from the bottom). Shoulders touch both edges, full hat stays, face gets ~57% budget. Better than autoframe's padding for these.
