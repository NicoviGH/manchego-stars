...
| `[Custom DM] Awakening Dark Mage [F]` battle animation | Ravisin, ch05's frost-druid boss — a STAND-IN chosen to match her Aversa bust (the FE-Repo has no Aversa anim; vendored at `engine/battle_anims/_vendored/awakening-dark-mage-f/`, #25) | still by **BatimatheBat**, animation by **Leo_Link** | F2U/F2E |
